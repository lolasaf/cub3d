...
#    Updated: 2025/06/01 22:26:28 by kforfoli         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS := $(addprefix $(SRCDIR)/, cast_ray.c draw_wall.c draw.c \
	...
	norm_sprites.c utils_sprites.c sort_sprites.c xtra.c sprites_load.c flooding.c)
#--- OBJECTS ---
...
#--- FLAGS ---
CC := cc
CFLAGS := -Wall -Wextra -Werror -I$(INCDIR) -fsanitize=address -I$(LIBFTDIR) -I$(MINILIBXDIR) \
	-I$(MLXHEADER) -g
